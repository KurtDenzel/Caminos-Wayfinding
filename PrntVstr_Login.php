					              ...
					              <div class="card-body p-lg-5 text-black">				            
									...
									<div class="container text-center pt-2">
										...
										<div class="row mx-5 g-0">
											...
											<form action="PV_login.php" method="post">

												<!-- Name / Phone Number -->
												<div class="mb-3">
													<input type="text" class="form-control" name="Name" required placeholder="Name / Phone Number">
												</div>
												<!-- Name / Phone Number -->
												...
												<!-- Purpose of Visit -->
												<div class="mb-3">
													<input type="text" name="PurposeVisit" required class="form-control" placeholder="Purpose of Visit ?">
												</div>			  
												<!-- Purpose of Visit -->
												...
												<div class="justify-content-center mt-3">
													<div class="d-grid gap-2">
														<button type="submit" name="login" value="login" class="btn btn-primary block">Login</button>
													</div>
												</div>
												<!-- Login Procedure -->	
